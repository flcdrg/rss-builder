...
<xsl:template match="channel">
	...
	<body>		
		...
		<h1><a href="{$chanlink}"><xsl:value-of select="title" disable-output-escaping="yes"/></a></h1>
		<p class="rssnote">
			<strong>Note:</strong> This page is an RSS feed meant for display in an RSS reader such as <a href="http://www.bradsoft.com/feeddemon/">FeedDemon</a>.
		</p>
